import { Code, User, Briefcase } from "lucide-react"; // Import icons
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="gradient-border p-6 card-hover flex items-start gap-4">
              ...
              <div>
                <h4 className="text-lg font-semibold">User Focused</h4>
                <p className="text-muted-foreground text-sm">
            ...
            <div className="gradient-border p-6 card-hover flex items-start gap-4">
              ...
              <div>
                <h4 className="text-lg font-semibold">Professional Projects</h4>
                <p className="text-muted-foreground text-sm">
